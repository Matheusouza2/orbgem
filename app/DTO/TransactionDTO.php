...
final readonly class TransactionDTO
{
    public function __construct(
        ...
        public ?string $notes, public ?int $recurringTransactionId, public ?int $creditCardInvoiceId,
    ...
    public static function fromArray(array $attributes, int $memberId = 0): self
    {
        return new self(
            ...
            $attributes['notes'] ?? null, $attributes['recurring_transaction_id'] ?? null,
