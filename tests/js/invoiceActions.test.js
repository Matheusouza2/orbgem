...
import { canPayCreditCardInvoice, shouldShowCreditCardInvoicePaymentAction } from '../../resources/js/Pages/Financial/Hooks/invoiceActions.js';
...
test('shows the payment action for an open invoice even when its balance is zero', () => {
    assert.equal(shouldShowCreditCardInvoicePaymentAction({ id: 1, status: 'OPEN', amount: 0 }), true);
});
