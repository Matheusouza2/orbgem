...
export default function Dashboard() {
    ...
    return <AppLayout>
        ...
        <TransactionModal open={transactionModalOpen} onClose={() => setTransactionModalOpen(false)} form={dashboard.form} accounts={dashboard.accounts} creditCards={dashboard.creditCards} categories={dashboard.categories} merchants={dashboard.merchants} onSubmit={async (event) => { const requestError = await dashboard.submitTransaction(event); if (!requestError) setTransactionModalOpen(false); }} onCreateMerchant={() => dashboard.setMerchantOpen(true)} submitting={dashboard.submitting} apiErrors={dashboard.apiErrors} />
