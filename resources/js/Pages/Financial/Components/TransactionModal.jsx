...
export default function TransactionModal({ open, onClose, form, accounts, creditCards = [], categories = [], merchants = [], onSubmit, onSubmitAndContinue, onCreateMerchant, submitting, apiErrors, editing = null }) {
    ...
    const handleSaveAndContinue = async (event) => {
        ...
        const requestError = await onSubmitAndContinue(event);
        if (!requestError) {
            setStep(1);
            setStepError('');
        }
