...
import { ArrowDownLeft, ArrowUpRight, CalendarDays, ChevronLeft, ChevronRight, CircleCheck, Pencil, ReceiptText } from 'lucide-react';
import { Suspense } from 'react';
import AccountIcon from './AccountIcon';
import Inputs from '@/Components/Inputs';
import { formatDateBR } from '@/Utils/date';
import { canEffectivateTransaction } from '../Hooks/transactionActions';
...
export default function AccountTransactionsModal({ account, transactions, meta, loading, error, filters, categories = [], onClose, onFilter, onPage, onEditTransaction, onEffectivate }) {
