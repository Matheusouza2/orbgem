...
export default function AccountTransactionsModal({ account, transactions, meta, loading, error, filters, onClose, onFilter, onPage, onEditTransaction, onEffectivate }) {
