const Checkbox = {
    "base": "h-4 w-4 appearance-none rounded border border-chicago-400 bg-chicago-300 bg-[length:0.55em_0.55em] bg-center bg-no-repeat checked:border-transparent checked:bg-current checked:bg-check-icon focus:outline-none focus:ring-2 focus:ring-offset-2 dark:border-chicago-400 dark:bg-chicago-300 dark:checked:border-transparent dark:checked:bg-current",
    "color": {
        ...
        "yellow": "text-yellow-400 focus:ring-yellow-400 dark:ring-offset-yellow-400 dark:focus:ring-yellow-400 bg-chicago-50 dark:bg-chicago-50 disabled:hover:cursor-not-allowed disabled:bg-chicago-300 disabled:shadow-none dark:disabled:hover:cursor-not-allowed dark:disabled:bg-chicago-300 dark:disabled:shadow-none"
    },
