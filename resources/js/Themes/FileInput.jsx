const FileInput = {
    ...
    "colors": {
        "gray": "border-gray-300 bg-gray-50 text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-chicago-50 dark:placeholder-gray-400 dark:focus:border-sunglow-500 dark:focus:ring-sunglow-500",
