const ToggleSwitch = {
    "root": {
        ...
        "label": "ms-3 mt-0.5 text-start text-sm font-medium text-chicago-900 dark:text-chicago-900",
        "input": "sr-only"
    },
    "toggle": {
        ...
        "checked": {
            ...
            "color": {
                "default": "bg-sunglow-500 group-focus:ring-sunglow-300 dark:group-focus:ring-sunglow-300",
